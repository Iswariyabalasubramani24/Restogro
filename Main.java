...
import com.splitwise.models.split.Percent;
...
public class Driver {
    public static void main(String[] args) {
        ...
        expenseManager.addUser(new User("u1", "User1", "gaurav@gmail.com", "9876543210"));
        expenseManager.addUser(new User("u2", "User2", "sagar@gmail.com", "9876543210"));
        expenseManager.addUser(new User("u3", "User3", "hi@gmail.com", "9876543210"));
        expenseManager.addUser(new User("u4", "User4", "mock-interviews@gmail.com", "9876543210"));
